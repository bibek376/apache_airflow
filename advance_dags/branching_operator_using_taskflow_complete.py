...
# @dag(dag_id='branching_operator_using_taskflow_api_complete',
...
#     @task(task_id='filter_two_seater_task')
#     def filter_two_seater(**kwargs):
#         ti=kwargs['ti']
...
#     @task(task_id='filter_except_two_seater_task')
#     def filter_except_two_seater(**kwargs):
#         ti=kwargs['ti']
#         json_data=ti.xcom_pull(task_ids='read_csv_file_task')
...
#     def write_csv_final_data(**kwargs):
#         ti=kwargs['ti']
...
#         filter_two_seater(), filter_except_two_seater() ] >> write_csv_final_data()
